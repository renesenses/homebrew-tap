class TuneServer < Formula
  ...
  url "https://github.com/renesenses/tune-server-linux/archive/refs/tags/v0.7.101.tar.gz"
  sha256 "ac8bef97c6f17df03c815d44127fe9e82eb5e62c3f74add5a51c96d7e5412072"
  version "0.7.101"
  license "MIT"
  ...
  resource "web-client" do
    url "https://github.com/renesenses/tune-web-client/archive/refs/tags/v0.7.101.tar.gz"
    sha256 "835a04ff21b799df661ffa38a7f4c7f1d7170cbd7610bf3e62631c0b48951430"
  end
  ...
  def caveats
    <<~EOS
      Tune Server v0.7.101 installed!
      ...
      Release notes:
        https://github.com/renesenses/tune-server-linux/releases/tag/v0.7.101
    EOS
  end
