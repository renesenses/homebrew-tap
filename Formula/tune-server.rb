class TuneServer < Formula
  ...
  url "https://github.com/renesenses/tune-server-linux/archive/refs/tags/v0.7.98.tar.gz"
  sha256 "b62d2c5f8473fd4bbd03c84bad1a7223b6c0f67c81a799e2b64dd37c5911609e"
  version "0.7.98"
  license "MIT"
  ...
  resource "web-client" do
    url "https://github.com/renesenses/tune-web-client/archive/refs/tags/v0.7.98.tar.gz"
    sha256 "eb6adb265b8ceecaf713fa09afe7039662ae335802bfb4f7e0ddcc47b3925023"
  end
  ...
  def caveats
    <<~EOS
      ...
      Release notes:
        https://github.com/renesenses/tune-server-linux/releases/tag/v0.7.98
    EOS
  end
