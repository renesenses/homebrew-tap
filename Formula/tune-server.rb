class TuneServer < Formula
  ...
  url "https://github.com/renesenses/tune-server-linux/archive/refs/tags/v0.7.106.tar.gz"
  sha256 "a2172549c11edf63735079e118bf3aa95fef39150f7fa6986bdc663864336f1e"
  version "0.7.106"
  license "MIT"
  ...
  resource "web-client" do
    url "https://github.com/renesenses/tune-web-client/archive/refs/tags/v0.7.106.tar.gz"
    sha256 "1b4e22b24539dbb6325ad22af1de6e41072894899e64429297df5a043e5203e2"
  end
  ...
  def caveats
    <<~EOS
      Tune Server v0.7.106 installed!
      ...
      Release notes:
        https://github.com/renesenses/tune-server-linux/releases/tag/v0.7.106
    EOS
  end
