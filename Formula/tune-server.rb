class TuneServer < Formula
  ...
  resource "web-client" do
    url "https://github.com/renesenses/tune-web-client/archive/refs/tags/v0.8.114.tar.gz"
    sha256 "cd892b4db6f4ed665b474409915f8cedea43fdfbd180bb3f4be076dd82345cbd"
  end
